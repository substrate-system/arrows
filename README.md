...
[![install size](https://flat.badgen.net/packagephobia/install/@bicycle-codes/arrows?cache-control=no-cache)](https://packagephobia.com/result?p=@bicycle-codes/arrows)
